		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Browser Orders",
									"targetURL": "#comlab2devbrowserorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devbrowserorders-display": {
								"semanticObject": "comlab2devbrowserorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.browserorders",
									"url": sap.ui.require.toUrl("com/lab2dev/browserorders")
								}
							}
						}
					}
